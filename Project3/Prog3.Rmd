...
La distribuzione empirica dei residui (in blu) si discosta tanto dalla distribuzione teorica (in rosso). Inoltre, il test di SW restituisce un p-value molto basso, dunque rigettiamo decisamente l'ipotesi gaussiana.
...
ts.ls.2015 = window(ts - ts.ls$resid, start = c(2015,1))
...
legend("topleft",legend=c("Serie storica", "Minimi quadrati", "Serie nel 2019", "Incertezza"), col=c("black","cyan","blue","red"), lty=1, cex=0.4)
```
